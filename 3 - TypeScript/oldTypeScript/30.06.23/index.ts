...
const userInput = prompt('enter 3 numbers with space between') //"1 23 56"
const array = userInput.split(' ') //array of string - ["1", "23", "56"]
const arrOfNumbers = array.map(i => Number(i)) //[1, 23, 56]

function funSome (arrOfNumber: number[]): string {
    const word = arrOfNumber[0].toString()
